...
class LogisticLoss(LossFunction):
    ...
    def lossGradient(self, X, Y, Yhat):
        ...
        ### TODO: YOUR CODE HERE
        #util.raiseNotDefined()
        numerator = Y * exp(multiply(-Y, Yhat))
        denominator = (1 + exp(multiply(-Y, Yhat)))
        return -sum(numerator/denominator*X.T, axis = 1)
...
class LinearClassifier(BinaryClassifier):
    ...
    def train(self, X, Y):
        ...
        def func(w):
            ...
            obj  = lossFn.loss(Y, Yhat) + (lambd * 0.5) * norm(w)**2    ### TODO: YOUR CODE HERE
