...
Files You'll Edit
dumbClassifiers.py预览文档: This contains a handful of "warm up" classifiers to get you used to our classification framework.

dt.py预览文档: Will be your simple implementation of a decision tree classifier.

knn.py预览文档: This is where your nearest-neighbor classifier modifications will go.

perceptron.py预览文档: Take a guess :).

Files you might want to look at
binary.py预览文档: Our generic interface for binary classifiers (actually works for regression and other types of classification, too).

datasets.py预览文档: Where a handful of test data sets are stored.

util.py预览文档: A handful of useful utility functions: these will undoubtedly be helpful to you, so take a look!

runClassifier.py预览文档: A few wrappers for doing useful things with classifiers, like training them, generating learning curves, etc.

mlGraphics.py预览文档: A few useful plotting commands
...
Training accuracy 0.92, test accuracy 0.925
```
